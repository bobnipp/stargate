...
/**
 * <p>Java class for prismResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="prismResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "prismResponse", propOrder = {
    "success",
    "errorMessages"
})
@XmlSeeAlso({
    PrismerShortResponse.class,
    PrismMissionShortResponse.class,
    PrismNomShortResponse.class,
    PrismcrShortResponse.class,
    PrismpirResponse.class,
    PrismTargetShortResponse.class,
    PrismipShortResponse.class
})
