...
@XmlSeeAlso({
    PrismerShortRequest.class,
    PrismMissionShortRequest.class,
    PrismNomShortRequest.class,
    PrismcrShortRequest.class,
    PrismpirRequest.class,
    PrismTargetShortRequest.class,
    PrismipShortRequest.class
})
